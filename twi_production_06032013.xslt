...
<xsl:variable name="global_font">Verdana, Helvetica, Arial, sans-serif</xsl:variable>
<xsl:variable name="global_font_size"></xsl:variable>
<xsl:variable name="global_bg_color">#ffffff</xsl:variable>
<xsl:variable name="global_text_color">#444444</xsl:variable>
<xsl:variable name="global_link_color">#005EAA</xsl:variable>
...
<xsl:variable name="twitter_search_operators">from:twi_ltd</xsl:variable>
...
<xsl:variable name="res_title_length">80</xsl:variable>
<xsl:variable name="res_title_length_default">70</xsl:variable>
<xsl:variable name="res_title_color">#005EAA</xsl:variable>
...
<!--Header and Footer added by Shahid Mirza -->
  <xsl:text disable-output-escaping="yes">


&lt;div id="page-outer" class="fontSizeAdjustment"&gt;
	&lt;div id="page-inner"&gt;
		&lt;div id="page-body"&gt;
		
			
&lt;div id="usability-outer"&gt;
	&lt;div id="usability-inner" class="PageWidthAbsolute"&gt;
		&lt;div class="usability"&gt;
			&lt;map id="usability" class="usability"&gt;
				&lt;ul&gt;
					&lt;li&gt;&lt;a href="http://www.twi.co.uk/accessibility/" title="Accessibility"&gt;Accessibility&lt;/a&gt;&lt;/li&gt;
				&lt;/ul&gt;
			&lt;/map&gt;
		&lt;/div&gt;
		
		&lt;div class="top-links"&gt;
			&lt;map id="top-links" class="top-links"&gt;
				&lt;ul&gt;
                    &lt;li&gt;&lt;a href="http://www.twitraining.com" title="TWI Training" target="_blank"&gt;Training&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;|&lt;/li&gt;
                    &lt;li&gt;&lt;a href="http://www.twi.co.uk/about/careers/" title="Careers"&gt;Careers&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;|&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://www.twi.co.uk/contact/find-us/" title="Find us"&gt;Find us&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;|&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://www.twi.co.uk/site-map/" title="Site map" accesskey="3"&gt;Site map&lt;/a&gt;&lt;/li&gt;
...
&lt;div id="header-outer"&gt;
	&lt;div id="header-inner" class="PageWidthAbsolute"&gt;
	
		&lt;div id="logo-outer"&gt;
			&lt;div id="logo-inner"&gt;&lt;a href="http://www.twi.co.uk/home" title="TWI" class="oImageLink" accesskey="1"&gt;&lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/logo.gif" alt="TWI" /&gt;&lt;/a&gt;&lt;/div&gt;
		&lt;/div&gt;
		
		&lt;!-- // Remove One Search Panel From Header or Default // --&gt;
		&lt;div id="search-panel-outer"&gt;
			&lt;div id="search-panel-inner"&gt;
				&lt;form method="get" action="http://google.twi.co.uk/search" id="search-form"&gt;

&lt;input type="hidden" name="site" value="twi_all"/&gt;

<!-- C.Elswood change, carry search parameters in top site search -->
...
<!-- End change -->
					...
					&lt;fieldset class="hide"&gt;
						&lt;legend class="hide"&gt;Search our Site&lt;/legend&gt;
						&lt;div id="search-form-outer"&gt;
							&lt;div id="search-form-inner"&gt;
								&lt;div class="oDataFormElement"&gt;
									&lt;span class="oDataSearchFormLabel"&gt;&lt;label id="search-title" for="search-keywords" class="SearchLabel"&gt;Search our site&lt;/label&gt;&lt;/span&gt;
								&lt;/div&gt;
								&lt;div class="oDataFormElement"&gt;
									&lt;span class="oDataSearchFormInputText"&gt;&lt;input id="search-keywords" class="SearchKeywords" type="text" name="q" accesskey="4" value="Search" onfocus="if (this.value=='Search') { this.value=''; };return true;" /&gt;&lt;/span&gt;
									&lt;span class="oDataSearchFormButton"&gt;&lt;input id="search-submit" class="SearchButton" type="submit" value=""  /&gt;&lt;/span&gt;
								&lt;/div&gt;
							&lt;/div&gt;
						&lt;/div&gt;
					&lt;/fieldset&gt;
...
&lt;!-- --------------------------- TOP BANNER AND SEARCH FIELD ENDS----------------------------------- --&gt;

&lt;div id="main-outer"&gt;
				&lt;div id="menu-outer" class="PageWidthAbsolute"&gt;
					&lt;div id="menu-inner"&gt;
						&lt;div id="TWI-Top" class="style-element-outer custom-menu custom-menu-TWI-Top"&gt;&lt;div class="style-element-inner"&gt;&lt;div class="style-element-body clear"&gt;&lt;div class="footer-menu-panel fn-panel-alpha"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/home/" class="fm-panel-title" title="Home"&gt;
        &lt;span class="fm-panel-title"&gt;Home&lt;/span&gt;
      &lt;/a&gt;
    &lt;/li&gt;
  &lt;/ul&gt;
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-beta"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/technologies/" class="fm-panel-title" title="Technologies"&gt;
        &lt;span class="fm-panel-title"&gt;Technologies&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/technologies/welding-coating-and-material-processing/" class="fm-panel-item" title="Welding, Coating and Material Processing"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Welding, Coating and Material Processing&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/technologies/structural-integrity/" class="fm-panel-item" title="Structural Integrity"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Structural Integrity&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/technologies/material-properties/" class="fm-panel-item" title="Material Properties "&gt;
            &lt;span class="fm-panel-link-inner"&gt;Material Properties &lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/technologies/ndt/" class="fm-panel-item" title="NDT and Asset Reliability"&gt;
            &lt;span class="fm-panel-link-inner"&gt;NDT and Asset Reliability&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-gamma"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/industries/" class="fm-panel-title" title="Industries"&gt;
        &lt;span class="fm-panel-title"&gt;Industries&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/oil-and-gas/" class="fm-panel-item" title="Oil and Gas"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Oil and Gas&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/power/" class="fm-panel-item" title="Power"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Power&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/aerospace/" class="fm-panel-item" title="Aerospace"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Aerospace&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/construction-and-fabrication/" class="fm-panel-item" title="Construction and Fabrication"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Construction and Fabrication&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/automotive/" class="fm-panel-item" title="Automotive"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Automotive&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/rail/" class="fm-panel-item" title="Rail"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Rail&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/shipbuilding/" class="fm-panel-item" title="Shipbuilding"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Shipbuilding&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/off-highway/" class="fm-panel-item" title="Off Highway"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Off Highway&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/defence/" class="fm-panel-item" title="Defence"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Defence&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/equipment-consumables-and-materials/" class="fm-panel-item" title="Equipment, Consumables and Materials"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Equipment, Consumables and Materials&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/electronics-and-sensors/" class="fm-panel-item" title="Electronics and Sensors"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Electronics and Sensors&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/industries/medical/" class="fm-panel-item" title="Medical"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Medical&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-delta"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/services/" class="fm-panel-title" title="Services"&gt;
        &lt;span class="fm-panel-title"&gt;Services&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/research-and-consultancy/" class="fm-panel-item" title="Research and Consultancy"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Research and Consultancy&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/failure-investigation/" class="fm-panel-item" title="Failure Investigation"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Failure Investigation&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/manufacturing-support/" class="fm-panel-item" title="Manufacturing Support"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Manufacturing Support&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/welding-engineering/" class="fm-panel-item" title="Welding Engineering"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Welding Engineering&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/engineering-facilities/" class="fm-panel-item" title="Engineering Facilities"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Engineering Facilities&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/inspection-services/" class="fm-panel-item" title="Inspection Services"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Inspection Services&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/intellectual-property-licensing/" class="fm-panel-item" title="Intellectual Property Licensing"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Intellectual Property Licensing&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/training-and-examination/" class="fm-panel-item" title="Training and Examination"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Training and Examination&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/information-services/" class="fm-panel-item" title="Information Services"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Information Services&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/software/" class="fm-panel-item" title="Software"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Software&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/services/business-solutions/" class="fm-panel-item" title="Business Solutions"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Business Solutions&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-epsilon"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/news-events/" class="fm-panel-title" title="News &amp; Events"&gt;
        &lt;span class="fm-panel-title"&gt;News &amp; Events&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/news/" class="fm-panel-item" title="News"&gt;
            &lt;span class="fm-panel-link-inner"&gt;News&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/events/" class="fm-panel-item" title="Events"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Events&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/on-demand/" class="fm-panel-item" title="On-demand"&gt;
            &lt;span class="fm-panel-link-inner"&gt;On-demand&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/case-studies/" class="fm-panel-item" title="Case Studies"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Case Studies&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/connect/" class="fm-panel-item" title="Connect "&gt;
            &lt;span class="fm-panel-link-inner"&gt;Connect &lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/bulletin/" class="fm-panel-item" title="Bulletin"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Bulletin&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/industry-updates/" class="fm-panel-item" title="Industry Updates"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Industry Updates&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/news-events/videos/" class="fm-panel-item" title="Videos"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Videos&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-zeta"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/membership/" class="fm-panel-title" title="Membership"&gt;
        &lt;span class="fm-panel-title"&gt;Membership&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/membership/become-a-member/" class="fm-panel-item" title="Become a Member"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Become a Member&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/membership/our-members/" class="fm-panel-item" title="Our Members"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Our Members&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/membership/members-showcase/" class="fm-panel-item" title="Members' Showcase"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Members' Showcase&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-eta"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/about/" class="fm-panel-title" title="About Us"&gt;
        &lt;span class="fm-panel-title"&gt;About Us&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/executive-team/" class="fm-panel-item" title="Executive Team"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Executive Team&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/careers/" class="fm-panel-item" title="Careers"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Careers&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/innovation/" class="fm-panel-item" title="Innovation"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Innovation&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/support-for-uk-regions/" class="fm-panel-item" title="Support for UK Regions"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Support for UK Regions&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/professional-membership/" class="fm-panel-item" title="Professional Membership"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Professional Membership&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/twi-group/" class="fm-panel-item" title="TWI Group"&gt;
            &lt;span class="fm-panel-link-inner"&gt;TWI Group&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/twi-and-granta-park/" class="fm-panel-item" title="TWI and Granta Park"&gt;
            &lt;span class="fm-panel-link-inner"&gt;TWI and Granta Park&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/report-and-accounts/" class="fm-panel-item" title="Report and Accounts"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Report and Accounts&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/annual-review/" class="fm-panel-item" title="Annual Review"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Annual Review&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/about/procurement/" class="fm-panel-item" title="Procurement"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Procurement&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;/div&gt;&lt;div class="footer-menu-panel fn-panel-theta"&gt;
  &lt;ul&gt;
    &lt;li class="fm-panel-title"&gt;
      &lt;a href="http://www.twi.co.uk/contact/" class="fm-panel-title" title="Contact Us"&gt;
        &lt;span class="fm-panel-title"&gt;Contact Us&lt;/span&gt;
      &lt;/a&gt;
      &lt;ul class="fm-panel-list"&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/contact/twi-addresses/" class="fm-panel-item" title="TWI Addresses"&gt;
            &lt;span class="fm-panel-link-inner"&gt;TWI Addresses&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
        &lt;li class="fm-panel-item"&gt;
          &lt;a href="http://www.twi.co.uk/contact/find-us/" class="fm-panel-item" title="Find Us"&gt;
            &lt;span class="fm-panel-link-inner"&gt;Find Us&lt;/span&gt;
          &lt;/a&gt;
        &lt;/li&gt;
      &lt;/ul&gt;
    &lt;/li&gt;
...
&lt;div id="main-inner" class="PageWidthAbsolute"&gt;
	&lt;div id="main-content"&gt;
...
&lt;/div&gt;
        ...
        &lt;div id="social-media-footer-outer"&gt;
		
        
            &lt;div id="social-media-footer-inner" class="PageWidthAbsolute"&gt;

                &lt;a href="http://www.facebook.com/twiltd" target="_blank"&gt;
                    &lt;div id="facebook-label"&gt;Facebook&lt;/div&gt;
                    &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-facebook.png" class="social-media-facebook" alt="Add TWI on Facebook" /&gt;              
                &lt;/a&gt;

                &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-seperator.png" class="social-media-seperator1" alt="Add TWI on Facebook" /&gt;
                
                &lt;a href="https://twitter.com/twi_ltd" target="_blank"&gt;
                    &lt;div id="twitter-label"&gt;Twitter&lt;/div&gt;
                    &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-twitter.png" class="social-media-twitter" alt="Follow TWI on Twitter" /&gt;
                &lt;/a&gt;

                &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-seperator.png" class="social-media-seperator2" alt="Follow TWI on Twitter" /&gt;

                &lt;a href="https://plus.google.com/101179517724285350308" target="_blank"&gt;
                    &lt;div id="googleplus-label"&gt;Google+&lt;/div&gt;
                    &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-googleplus.png" class="social-media-googleplus" alt="Add TWI on Google plus" /&gt;
                &lt;/a&gt;
                    
                &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-seperator.png" class="social-media-seperator3" alt="Add TWI on Google plus" /&gt;

                &lt;a href="http://www.linkedin.com/groups?mostPopular=&amp;gid=2888580" target="_blank"&gt;
                    &lt;div id="linkedin-label"&gt;LinkedIn&lt;/div&gt;
                    &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-linkedin.png" class="social-media-linkedin" alt="Connect with TWI on LinkedIn" /&gt;
                &lt;/a&gt;

                &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-seperator.png" class="social-media-seperator4" alt="Connect with TWI on LinkedIn" /&gt;

                &lt;a href="http://www.youtube.com/twiltd" target="_blank"&gt;
                    &lt;div id="youtube-label"&gt;YouTube&lt;/div&gt;
                    &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-you-tube.png" class="social-media-youtube" alt="Watch TWI videos on YouTube" /&gt;
                &lt;/a&gt;

                &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-seperator.png" class="social-media-seperator5" alt="Connect with TWI on LinkedIn" /&gt;

                &lt;a href="http://www.flickr.com/photos/twiltd/" target="_blank"&gt;
                    &lt;div id="flickr-label"&gt;Flickr&lt;/div&gt;
                    &lt;img src="http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/social-media-bar/social-media-bar-flickr-logo.png" class="social-media-flickr" alt="View TWI image galleries" /&gt;
                &lt;/a&gt;
		...
		&lt;div id="footer-nav-outer"&gt;
			&lt;div id="footer-nav-inner" class="PageWidthAbsolute"&gt;
			
			&lt;div id="footer-link-container"&gt;
          &lt;div class="technologies-footer-links"&gt;&lt;h2&gt;Technologies&lt;/h2&gt;
            &lt;ul&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/technologies/welding-coating-and-fabrication/" title="Welding, Coating and Fabrication"&gt;Welding, Coating and Fabrication&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/technologies/structural-integrity/" title="Structural Integrity"&gt;Structural Integrity&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/technologies/materials/" title="Materials "&gt;Materials&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/technologies/ndt/" title="NDT and Asset Reliability"&gt;NDT and Asset Reliability&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
         &lt;/div&gt;
          &lt;div class="industries-footer-links"&gt;&lt;h2&gt;Industries&lt;/h2&gt;
             &lt;ul&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/industries/oil-and-gas/" title="Oil and Gas"&gt;Oil and Gas&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/industries/power/" title="Power"&gt;Power&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/industries/aerospace/" title="Aerospace"&gt;Aerospace&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/industries/construction-and-fabrication/" title="Construction and Fabrication"&gt;Construction and Fabrication&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/industries/automotive/" title="Automotive"&gt;Automotive&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/industries/" title="Industries"&gt;See more &gt;&gt;&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
          &lt;/div&gt;
          &lt;div class="services-footer-links"&gt;&lt;h2&gt;Services&lt;/h2&gt;
              &lt;ul&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/services/research-and-consultancy/" title="Research and Consultancy"&gt;Research and Consultancy&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/services/failure-investigation/" title="Failure investigation"&gt;Failure investigation&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/services/business-solutions/" title="Business Solutions"&gt;Business Solutions&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/services/manufacturing-support/" title="Manufacturing Support"&gt;Manufacturing Support&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twi.co.uk/services/welding-engineering/" title="Welding Engineering"&gt;Welding Engineering&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a class="oLinkInternal" href="http://www.twi.co.uk/services/" title="Services"&gt;See more &gt;&gt;&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
          &lt;/div&gt;
          &lt;div class="companies-footer-links"&gt;&lt;h2&gt;Group Companies / Websites&lt;/h2&gt;
          &lt;div class="companies-footer-links-bx-one"&gt;
             &lt;ul&gt;
              &lt;li&gt;&lt;a href="http://www.twitraining.com" title="TWI Training" target="_blank"&gt;TWI Training&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.cswip.com" title="CSWIP" target="_blank"&gt;CSWIP&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twicertification.com/" title="TWI Certification" target="_blank"&gt;TWI Certification&lt;/a&gt;&lt;/li&gt; 
              &lt;li&gt;&lt;a href="http://www.twiprofessional.com" title="TWI Professional" target="_blank"&gt;The Welding Institute&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.twisoftware.com/home/home.jsp" title="TWI Software" target="_blank"&gt;TWI Software&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.thetesthouse.co.uk" title="The Test House" target="_blank"&gt;The Test House&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
            &lt;/div&gt;
            &lt;div class="companies-footer-links-bx-two"&gt;
            &lt;ul&gt;
              &lt;li&gt;&lt;a href="http://www.twinorthamerica.com" title="TWI North America" target="_blank"&gt;TWI North America&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.plantintegrity.com" title="Plant Integrity" target="_blank"&gt;Plant Integrity&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.ndt-validation.com" title="NDT Validation Centre" target="_blank"&gt;NDT Validation Centre&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.iorw.org" title="IORW" target="_blank"&gt;IORW&lt;/a&gt;&lt;/li&gt;
              &lt;li&gt;&lt;a href="http://www.abingtonhall.co.uk" title="Abington Hall" target="_blank"&gt;Abington Hall&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
            &lt;/div&gt;
          &lt;/div&gt;
			&lt;/div&gt;
		...
		&lt;div id="footer-outer"&gt;
			&lt;div id="footer-inner" class="PageWidthAbsolute"&gt;
				&lt;div id="footer-alpha-outer"&gt;
					&lt;div id="footer-alpha-inner"&gt;
						&lt;div&gt;&lt;p&gt;TWI Ltd, Granta Park, Great Abington, Cambridge, CB21 6AL, United Kingdom&lt;/p&gt;&lt;/div&gt;
						&lt;div class="copyright"&gt;&lt;p&gt;Copyright &amp;copy;2013 TWI Ltd. All rights reserved.&lt;/p&gt;&lt;/div&gt;
					&lt;/div&gt;
				&lt;/div&gt;
				&lt;div id="footer-beta-outer"&gt;
					&lt;div id="footer-beta-inner"&gt;
						&lt;div class="telephone"&gt;&lt;p&gt;Tel: +44 (0)1223 899000&lt;/p&gt;&lt;/div&gt;

						&lt;div class="footer-links"&gt;
							&lt;map id="footer-links"&gt;
								&lt;ul class="footer-links"&gt;
									&lt;li class="start"&gt;&lt;a href="http://www.twi.co.uk/terms/" class="footer-link" title="Terms &amp; conditions" accesskey="8"&gt;&lt;span class="footer-link-inner"&gt;Terms &amp; conditions&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
									&lt;li&gt;|&lt;/li&gt;
									&lt;li class="end"&gt;&lt;a href="http://www.twi.co.uk/privacy/" class="footer-link" title="Privacy"&gt;&lt;span class="footer-link-inner"&gt;Privacy and Cookies&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
								&lt;/ul&gt;
							&lt;/map&gt;
						&lt;/div&gt;
					&lt;/div&gt;
...
<xsl:template name="result_page_header">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="margin-left:15px; margin-bottom:15px;">
...
<tr>
<td>
  <span class="p" style="font-size:90%;">
  <br/>
...
div#clustering {min-height:64px; font-size: 84%; _height: 65px;}
div#clustering h3 {font-size: 130%; font-weight: bold; margin: 0; padding: 0;}
div#clustering table {font-size: 100%; padding-top:4px;}
...
<!-- C.Elswood - Retain query value on subsequent searches and translate special characters to input text -->

  <xsl:variable name="original_query">
    <xsl:choose>
      <xsl:when test="/GSP/PARAM[(@name='q') and (@value!='')]">
        <xsl:value-of select="translate(/GSP/PARAM[@name='q']/@original_value, '+,%20', ' ')" disable-output-escaping="yes"/>
      </xsl:when>
      <xsl:otherwise>
<xsl:value-of select="/GSP/PARAM[@name='q']/@original_value"/>
</xsl:otherwise>
...
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_all')]">
   <option value="twi_all" selected="selected">Content Type (All)</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_all">Content Type (All)</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_bestpracticeguides')]">
   <option value="twi_bestpracticeguides" selected="selected">Best Practice Guides</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_bestpracticeguides">Best Practice Guides</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_bulletin')]">
   <option value="twi_bulletin" selected="selected">Bulletin</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_bulletin">Bulletin</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_casestudies')]">
   <option value="twi_casestudies" selected="selected">Case Studies</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_casestudies">Case Studies</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_connect')]">
   <option value="twi_connect" selected="selected">Connect</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_connect">Connect</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_faq')]">
   <option value="twi_faq" selected="selected">FAQ</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_faq">FAQ</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_jobknowledge')]">
   <option value="twi_jobknowledge" selected="selected">Job Knowledge</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_jobknowledge">Job Knowledge</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_knowledgesummaries')]">
   <option value="twi_knowledgesummaries" selected="selected">Knowledge Summaries</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_knowledgesummaries">Knowledge Summaries</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_memberreports')]">
   <option value="twi_memberreports" selected="selected">Report Summaries</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_memberreports">Report Summaries</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_publishedpapers')]">
   <option value="twi_publishedpapers" selected="selected">Published Papers</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_publishedpapers">Published Papers</option>
  </xsl:otherwise>
</xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='twi_videos')]">
   <option value="twi_videos" selected="selected">Videos</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="twi_videos">Videos</option>
  </xsl:otherwise>
</xsl:choose>
</select>
...
<!-- **********************************************************************
  Document filter menu beside the search box  C.Elswood
     ********************************************************************** -->
<xsl:template name="docfilter_menu">
  <xsl:if test="$search_docfilter != ''">
    <td valign="middle" style="padding-left:5px;">

<select name="as_q">
                     <xsl:choose>
                          <xsl:when test="PARAM[(@name='as_q') and (@value!='')]">
                            <option value="">any format</option>
                          </xsl:when>
                          <xsl:otherwise>
                            <option value="" selected="selected">any format</option>
                        ...
                        <xsl:choose>
                          <xsl:when test="PARAM[(@name='as_q') and (@value='filetype:pdf')]">
                            <option value="filetype:pdf" selected="selected">Adobe Acrobat PDF (.pdf)</option>
                          </xsl:when>
                          <xsl:otherwise>
                            <option value="filetype:pdf">Adobe Acrobat PDF (.pdf)</option>
                          </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                          <xsl:when test="PARAM[(@name='as_q') and (@value='filetype:htm OR filetype:html')]">
                            <option value="filetype:htm OR filetype:html" selected="selected">Web Page (.html)</option>
                          </xsl:when>
                          <xsl:otherwise>
                            <option value="filetype:htm OR filetype:html">Web Page (.html)</option>
                          </xsl:otherwise>
                        </xsl:choose>
          ...
          <font size="-1">
            <xsl:choose>
              ...
              <xsl:when test="$show_suggest = '1' and (($type = 'home') or ($type = 'std_top'))">
                ...
                <tr><td>
                <input type="text" name="q" size="{$search_box_size}" maxlength="256" value="{$original_query}" autocomplete="off" onkeyup="ss_handleKey(event)"/>
                </td></tr>
                <tr><td>
              ...
              <xsl:otherwise>
                <input type="text" name="q" size="{$search_box_size}" maxlength="256" value="{$original_query}"/>
              </xsl:otherwise>
            </xsl:choose>
          </font>
          </td>
          <xsl:call-template name="collection_menu"/>
          <xsl:call-template name="docfilter_menu"/>
...
<xsl:template name="spelling">
  <xsl:if test="/GSP/Spelling/Suggestion">
    <p><span class="p" style="padding-left:15px;"><font color="{$spelling_text_color}">
...
<xsl:template match="R">
  ...
  <xsl:if test="$show_res_title != '0'">
    ...
    <xsl:choose>
      ...
      <xsl:when test="@MIME='application/pdf'"><img  border="0" src="http://www.twi.co.uk/EasysiteWeb/getresource.axd?AssetID=1152838" alt="" height="25" width="25"/></xsl:when>
...
<!-- URL modification when result points to secure content C.Elswood -->
 <xsl:variable name="rewrite_from" select="'www.twi.co.uk/EasysiteWeb/getresource.axd?AssetID='"/>
 <xsl:variable name="rewrite_to" select="'http://www.twi.co.uk/EasySiteWeb/GatewayLink.aspx?alId='"/>
<xsl:variable name="rewrite_end" select="'&amp;type=full&amp;servicetype=Attachment'"/>
       <xsl:variable name="rewritten_url">
                <xsl:choose>
                <xsl:when test="contains(U, $rewrite_from)">
       ...
       <xsl:variable name="complete_url">
                <xsl:choose>
                <xsl:when test="contains($rewritten_url, $rewrite_end)">
                <xsl:value-of select="substring-before($rewritten_url, $rewrite_end)"/>
                </xsl:when>
                <xsl:otherwise>
       <xsl:value-of select="U"/>
                </xsl:otherwise>
...
<xsl:value-of disable-output-escaping='yes' select="$complete_url"/>
  ...
  <!-- *** Start Google result navigation bar *** -->
    ...
    <table border="0" cellpadding="0" width="1%" cellspacing="0">
      <tr align="center" valign="top">
        <xsl:if test="$navigation_style_to_use != 'top'">
<!-- Item removed to clean up bottom navigation C.Elswood        
...
<xsl:template name="top_sep_bar">
  ...
  <xsl:param name="time"/>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="{$sep_bar_bg_color}" style="padding-left:15px; padding-right:15px;">
      <tr>
...
#main-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-bg.jpg") no-repeat scroll center -39px #005EAA;
    clear: both;
    padding-top: 9px;
}
#main-inner {
...
#left-top {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/left-top.gif") no-repeat scroll center top #005EAA;
    color: #FFFFFF;
    font-size: 1.2em;
    margin-bottom: 8px;
    padding: 9px 14px;
...
#usability-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/top-bg.gif") repeat-x scroll left top #EDEDED;
    clear: both;
    color: #BCBCBC;
    padding: 0 0 5px;
}
...
.top-links li.login-link a:link, .top-links li.login-link a:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/login-bg.gif") no-repeat scroll left bottom transparent;
    color: #FFFFFF;
    display: inline-block;
    padding: 0;
    text-decoration: none;
}
.top-links li.login-link a:hover, .top-links li.login-link a:active {
}
.top-links li.login-link a:link span, .top-links li.login-link a:visited span {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/login-bg-r.gif") no-repeat scroll right bottom transparent;
    display: inline-block;
...
.top-links li.knowledge-button a:link, .top-links li.knowledge-button a:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/knowledge-bg.gif") no-repeat scroll left bottom transparent;
    color: #FFFFFF;
    display: inline-block;
    padding: 0;
    text-decoration: none;
}
.top-links li.knowledge-button a:hover, .top-links li.knowledge-button a:active {
}
.top-links li.knowledge-button a:link span, .top-links li.knowledge-button a:visited span {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/knowledge-bg-r.gif") no-repeat scroll right bottom transparent;
    display: inline-block;
    padding: 7px 20px 4px;
}
.top-links li.knowledge-button a:hover span, .top-links li.knowledge-button a:active span {
    color: #FFFFFF;
    text-decoration: underline;
}
fieldset.oLoginForm {
...
#menu-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-off.gif") no-repeat scroll left top transparent;
    overflow: hidden;
    width: 100%;
}
.custom-menu-TWI-Top {
...
.custom-menu-TWI-Top ul {
    list-style-type: none;
    margin: 0;
    padding: 0;
}
.custom-menu-TWI-Top li.fm-panel-title {
    float: left;
    list-style: none outside none;
    margin: 0;
}
.custom-menu-TWI-Top a.fm-panel-title:link, .custom-menu-TWI-Top a.fm-panel-title:visited {
...
.custom-menu-TWI-Top a.fm-panel-title span {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/nav-sep.gif") no-repeat scroll left top transparent;
    display: block;
    padding: 16px 0;
}
.custom-menu-TWI-Top a.fm-panel-title:hover {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") no-repeat scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top a.fm-panel-title:hover span {
}
.custom-menu-TWI-Top ul.fm-panel-list {
...
.custom-menu-TWI-Top ul.fm-panel-list span {
}
.custom-menu-TWI-Top.style-element-outer {
    margin: 0;
}
.custom-menu-TWI-Top .fn-panel-alpha a.fm-panel-title span {
    background: none repeat scroll 0 0 transparent;
}
.custom-menu-TWI-Top .fn-panel-alpha a.fm-panel-title:hover, .custom-menu-TWI-Top .fn-panel-alpha a.fm-panel-title:hover {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on-left.gif") no-repeat scroll left top transparent;
}
.custom-menu-TWI-Top .fn-panel-theta a.fm-panel-title:hover, .custom-menu-TWI-Top .fn-panel-theta a.fm-panel-title:hover {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on-right.gif") no-repeat scroll right top transparent;
}
.custom-menu-TWI-Top .fn-panel-alpha a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-alpha a.fm-panel-title:visited {
    width: 85px;
}
.custom-menu-TWI-Top .fn-panel-beta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-beta a.fm-panel-title:visited {
    width: 139px;
}
.custom-menu-TWI-Top .fn-panel-gamma a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-gamma a.fm-panel-title:visited {
    width: 119px;
}
.custom-menu-TWI-Top .fn-panel-delta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-delta a.fm-panel-title:visited {
    width: 108px;
}
.custom-menu-TWI-Top .fn-panel-epsilon a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-epsilon a.fm-panel-title:visited {
    width: 153px;
}
.custom-menu-TWI-Top .fn-panel-zeta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-zeta a.fm-panel-title:visited {
    width: 122px;
}
.custom-menu-TWI-Top .fn-panel-eta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-eta a.fm-panel-title:visited {
    width: 115px;
}
.custom-menu-TWI-Top .fn-panel-theta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-theta a.fm-panel-title:visited {
    width: 119px;
}
.custom-menu-TWI-Top .fn-panel-alpha.selected-alpha a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-alpha.selected-alpha a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on-left.gif") no-repeat scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-beta.selected-beta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-beta.selected-beta a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") repeat-x scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-gamma.selected-gamma a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-gamma.selected-gamma a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") repeat-x scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-delta.selected-delta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-delta.selected-delta a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") repeat-x scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-epsilon.selected-epsilon a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-epsilon.selected-epsilon a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") repeat-x scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-zeta.selected-zeta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-zeta.selected-zeta a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") repeat-x scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-eta.selected-eta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-eta.selected-eta a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on.gif") repeat-x scroll left top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.custom-menu-TWI-Top .fn-panel-theta.selected-theta a.fm-panel-title:link, .custom-menu-TWI-Top .fn-panel-theta.selected-theta a.fm-panel-title:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/tab-on-right.gif") repeat-x scroll right top transparent;
    border-bottom: 1px solid #FFFFFF;
    color: #005DAB;
}
.null {
...
#search-panel-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/search-top.gif") no-repeat scroll left top transparent;
    float: right;
    font-size: 1em;
    margin-top: 35px;
    width: 300px;
...
#search-panel-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/search-bottom.gif") no-repeat scroll left bottom transparent;
    overflow: hidden;
    width: 100%;
}
#search-form-outer {
...
.SearchButton {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/search-top.gif") no-repeat scroll right -2px transparent;
    border: 0 none;
    cursor: pointer;
    float: right;
    height: 2em;
...
#AdminLinksInner a:link, a.AdminLinks:link, #AdminLinksInner a:visited, a.AdminLinks:visited {
    text-decoration: none;
}
#AdminLinksInner a:hover, a.AdminLinks:hover, #AdminLinksInner a:active, a.AdminLinks:active {
    text-decoration: underline;
}
.ClientAreaContainer {
    width: 100%;
...
.pel-outer.columns-outer.columns-alpha .column-outer .column-inner {
    padding: 0 7px;
}
.pel-outer.columns-outer.columns-alpha .column-outer.column-alpha .column-inner {
    padding-left: 0;
}
.pel-outer.columns-outer.columns-alpha .column-outer.column-gamma .column-inner {
    padding-right: 0;
}
.element-panel-alpha-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/panel-alpha-bl.gif") no-repeat scroll left bottom transparent;
    clear: both;
    margin-bottom: 18px;
}
.element-panel-alpha-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/panel-alpha-br.gif") no-repeat scroll right bottom transparent;
    overflow: hidden;
    width: 100%;
}
...
.element-panel-alpha-body-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/panel-alpha-tl.gif") no-repeat scroll left top transparent;
}
.element-panel-alpha-body-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/panel-alpha-tr.gif") no-repeat scroll right top transparent;
}
...
.element-panel-beta-header-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/panel-beta-header.gif") no-repeat scroll right top transparent;
    padding: 8px 0;
}
...
div.element-panel-beta-body-content-inner ul li {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/panel-beta-bullet.gif") no-repeat scroll left 0.6em transparent;
    list-style-type: none;
    margin: 0;
    padding: 3px 0 3px 10px;
}
.page-element-outer.panel-delta {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-bg.gif") no-repeat scroll left 2.8em transparent;
    clear: both;
    margin-bottom: 18px;
}
...
.page-element-outer.panel-delta .panel-header-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-top.gif") no-repeat scroll left top #565656;
}
.page-element-outer.panel-delta .panel-header-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-top-r.gif") no-repeat scroll right top transparent;
    color: #FFFFFF;
    padding: 11px 16px 6px;
}
.page-element-outer.panel-delta .panel-body-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-bl.gif") no-repeat scroll left bottom transparent;
}
.page-element-outer.panel-delta .panel-body-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-br.gif") no-repeat scroll right bottom transparent;
    padding: 15px 15px 0;
}
...
.ModuleSearchButton, .DataFormButton {
    background: none repeat scroll 0 0 #EEEEEE;
    border: 1px solid #CCCCCC;
    color: #000000;
    margin: 0.5em;
...
.Edit_PageProperties_Title {
    background: none repeat scroll 0 0 #404050;
    color: White;
    font-weight: bold;
    padding: 5px;
    text-align: center;
...
.Edit_PageProperties_SubSection {
    background: none repeat scroll 0 0 #F0F0E0;
    color: Black;
    padding: 2px;
    text-align: center;
}
...
.oRSSFeedContainerOuter, .oBoxContainerOuter {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-bg.gif") no-repeat scroll left 2.8em transparent;
    clear: both;
}
.oRSSFeedContainerInner, .oBoxContainerInner {
    overflow: hidden;
    width: 100%;
}
.oRSSFeedHeaderOuter, .oBoxHeaderOuter {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-top.gif") no-repeat scroll left top #565656;
}
...
.oRSSFeedBodyOuter, .oBoxBodyOuter {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-bl.gif") no-repeat scroll left bottom transparent;
}
.oRSSFeedBodyInner, .oBoxBodyInner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-br.gif") no-repeat scroll right bottom transparent;
...
li.oHeadlineBoxItem a.oHeadlineBoxLink:link, li.oHeadlineBoxItem a.oHeadlineBoxLink:visited {
    color: #005EAA;
    display: block;
    padding: 3px 0;
    text-decoration: none;
}
li.oHeadlineBoxItem .oHeadlineBoxItem.oHeadlineBoxItemMoreInfo a.oHeadlineBoxLink:link, li.oHeadlineBoxItem .oHeadlineBoxItem.oHeadlineBoxItemMoreInfo a.oHeadlineBoxLink:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/hl-more-bullet.gif") no-repeat scroll right center transparent;
    display: block;
    padding-right: 20px;
    text-align: right;
}
li.oHeadlineBoxItem .HeadlineBoxSummaryText .oHeadlineBoxItemDate {
    color: #777777;
    display: block;
    padding: 3px 0;
}
...
.DataGrid thead {
    background: none repeat scroll 0 0 #C9D6E0;
}
.oPaginationIcon {
    font-size: 1em;
    font-weight: bold;
...
.DataGrid.oDataGrid.oEventDataGridPanels {
    border: 1px solid #CCCCCC;
    border-collapse: collapse;
    empty-cells: show;
    font-size: 1em;
...
.DataGrid.oDataGrid.oEventDataGridPanels th {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/button.gif") repeat-x scroll left top #005EAB !important;
...
.DataGrid.oDataGrid.oEventDataGridPanels td {
    border: 0 none !important;
    color: #4B414B;
    padding: 5px 10px !important;
}
.DataGrid.oDataGrid.oEventDataGridList {
    border: 1px solid #CCCCCC;
    border-collapse: collapse;
    empty-cells: show;
    font-size: 1em;
...
.DataGrid.oDataGrid.oEventDataGridList th {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/button.gif") repeat-x scroll left top #005EAB !important;
    border: 0 none !important;
    color: #FFFFFF;
    font-weight: normal;
...
.DataGrid.oDataGrid.oEventDataGridList td {
    border: 0 none !important;
    color: #4B414B;
    padding: 5px 10px !important;
}
...
th.oDataGridHeader a:link, th.oDataGridHeader a:visited {
    color: #FFFFFF;
    text-decoration: none;
}
td.oDataGridCell {
...
td.oDataGridCell a:link, td.oDataGridCell a:visited {
    color: #0066CC;
    text-decoration: underline;
}
td.oDataGridCell a:hover, td.oDataGridCell a:active {
    background: none repeat scroll 0 0 transparent;
    color: #4A5C68;
    text-decoration: underline;
}
...
a.oDataGridHeaderLink:link, a.oDataGridHeaderLink:visited {
    background: none repeat scroll 0 center transparent;
    color: #4A5C68;
}
a.oDataGridHeaderLink:hover, .oDataGridHeaderLink:active {
    background: none repeat scroll 0 0 transparent;
    color: #4A5C68;
}
a.oDataGridHeaderLinkSortAsc, a.oDataGridHeaderLinkSortAsc:link, a.oDataGridHeaderLinkSortAsc:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/SupportFiles/Images/icons/asc.gif") no-repeat scroll right center transparent;
    padding-right: 15px;
}
a.oDataGridHeaderLinkSortAsc:hover, a.oDataGridHeaderLinkSortAsc:active {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/SupportFiles/Images/icons/asc.gif") no-repeat scroll right center transparent;
    padding-right: 15px;
}
a.oDataGridHeaderLinkSortDesc, a.oDataGridHeaderLinkSortDesc:link, a.oDataGridHeaderLinkSortDesc:visited {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/SupportFiles/Images/icons/desc.gif") no-repeat scroll right center transparent;
    padding-right: 15px;
}
a.oDataGridHeaderLinkSortDesc:hover, a.oDataGridHeaderLinkSortDesc:active {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/SupportFiles/Images/icons/desc.gif") no-repeat scroll right center transparent;
    padding-right: 15px;
}
a.selected {
...
fieldset.oDataFormFieldset .oDataFormElementContainer, fieldset.oDataFormFieldset .oDataElementContainer {
...
.oDataFormCheckboxList input {
    margin-bottom: 0;
}
.oDataFormCheckboxList li {
    margin-bottom: 1em;
    overflow: hidden;
}
.oDataFormCheckboxList li input {
    float: left;
}
.oDataFormCheckboxList li label {
    display: inline-block;
    padding-top: 3px;
}
...
.oDataFormButton {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/button.gif") repeat-x scroll left top #005EAB;
    border: 0 none;
    color: #FFFFFF;
    font-size: 1em;
    margin: 0 10px 0 0;
...
#social-media-footer-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/images/social-media-bar/social-media-bar-bg.jpg") no-repeat scroll center top #888888;
    height: 60px;
}
...
.social-media-facebook, .social-media-twitter, .social-media-googleplus, .social-media-linkedin, .social-media-youtube, .social-media-flickr {
    position: absolute;
    top: 16px;
}
...
#facebook-label, #twitter-label, #googleplus-label, #linkedin-label, #youtube-label, #flickr-label {
    position: absolute;
    top: 22px;
}
#facebook-label {
...
.social-media-seperator1, .social-media-seperator2, .social-media-seperator3, .social-media-seperator4, .social-media-seperator5 {
    position: absolute;
    top: 7px;
}
.social-media-seperator1 {
    left: 150px;
}
.social-media-seperator2 {
    left: 313px;
}
.social-media-seperator3 {
    left: 486px;
}
.social-media-seperator4 {
    left: 664px;
}
.social-media-seperator5 {
    left: 840px;
}
#social-media-footer-inner a, #social-media-footer-inner a {
    color: #333333;
    text-decoration: none;
}
#social-media-footer-inner a:hover {
    text-decoration: underline;
}
...
.oNavigationItemParent, .oNavigationItemCurrent, .oNavigationItemSibling, .oNavigationItemChild, ul.oNavigationList li {
    list-style-type: none;
}
...
a.current-link:link, a.current-link:visited {
    color: #005EAA;
    display: block;
}
a.current-link:hover, a.current-link:active {
    color: #005EAA;
}
.snv-sibling-outer {
...
.snv-sibling-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
...
.snv-toplevel-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow-parent.gif") no-repeat scroll left center #FFFFFF;
    margin: 0;
    padding: 10px 10px 8px;
}
a.toplevel-link:link, a.toplevel-link:visited {
    color: #005EAA;
    display: block;
}
a.toplevel-link:hover, a.toplevel-link:active {
}
.oNavigationItemPath0 .snv-current-outer {
    border-bottom: 1px dotted #BFBFBF;
}
.oNavigationItemPath0 .snv-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow-parent.gif") no-repeat scroll left center #FFFFFF;
    color: #005EAA;
    padding: 10px 10px 8px;
}
.oNavigationItemPath1 .snv-current-outer {
    border-bottom: 1px dotted #BFBFBF;
}
.oNavigationItemPath1 .snv-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    color: #005EAA;
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath1 .snv-sibling-outer, .oNavigationItemPath1 .snv-child-outer {
    border-bottom: 1px solid #BFBFBF;
    margin: 0;
}
.oNavigationItemPath1 .snv-sibling-inner, .oNavigationItemPath1 .snv-child-inner {
    padding: 10px 10px 8px 20px;
}
...
.oNavigationItemPath1 .snv-path-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath2 .snv-current-outer {
    border-bottom: 1px dotted #BFBFBF;
    margin: 0 0 0 10px;
}
.oNavigationItemPath2 .snv-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    color: #005EAA;
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath2 .snv-sibling-outer, .oNavigationItemPath2 .snv-child-outer {
    border: 0 none;
    margin: 0 0 0 10px;
}
.oNavigationItemPath2 .snv-sibling-inner, .oNavigationItemPath2 .snv-child-inner {
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath2 .snv-path-sibling-outer {
    border: 0 none;
    margin: 0 0 0 10px;
}
.oNavigationItemPath2 .snv-path-sibling-inner {
}
...
.oNavigationItemPath2 .snv-path-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath3 .snv-current-outer {
    border: 0 none;
    margin: 0 0 0 20px;
}
.oNavigationItemPath3 .snv-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    color: #005EAA;
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath3 .snv-sibling-outer {
    border: 0 none;
    margin: 0 0 0 20px;
}
.oNavigationItemPath3 .snv-sibling-inner {
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath3 .snv-child-outer, .oNavigationItemPath3 .snv-path-outer {
    margin: 0 0 0 20px;
}
.oNavigationItemPath3 .snv-child-inner, .oNavigationItemPath3 .snv-path-inner {
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath4 .snv-current-outer {
    border: 0 none;
    margin: 0 0 0 30px;
}
.oNavigationItemPath4 .snv-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    color: #005EAA;
    padding: 10px 10px 8px 20px;
}
...
.oNavigationItemPath4 .snv-sibling-inner {
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath4 .snv-child-outer, .oNavigationItemPath4 .snv-path-outer {
    margin: 0 0 0 20px;
}
.oNavigationItemPath4 .snv-child-inner, .oNavigationItemPath4 .snv-path-inner {
    padding: 10px 10px 8px 20px;
}
...
.oNavigationItemPath5 .snv-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow.gif") no-repeat scroll left center #FFFFFF;
    color: #005EAA;
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath5 .snv-sibling-outer {
    border: 0 none;
    margin: 0 0 0 40px;
}
.oNavigationItemPath5 .snv-sibling-inner {
    padding: 10px 10px 8px 20px;
}
.oNavigationItemPath5 .snv-child-outer, .oNavigationItemPath5 .snv-path-outer {
    margin: 0 0 0 20px;
}
.oNavigationItemPath5 .snv-child-inner, .oNavigationItemPath5 .snv-path-inner {
    padding: 10px 10px 8px 20px;
}
...
.snv-path-current-outer {
    display: block;
}
.snv-path-current-inner {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/main-nav-arrow-child.gif") no-repeat scroll left center #FFFFFF;
...
#footer-nav-outer {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/footer-bg.jpg") no-repeat scroll center top #888888;
    clear: both;
    color: #666666;
width:100%;
height:200px;
...
.style-element-outer.custom-menu.custom-menu-TWI-Bottom {
    margin: 15px 0 0;
}
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/footer-panel-sep.gif") repeat-y scroll left top transparent;
    float: left;
    height: auto !important;
    margin: 0;
    min-height: 260px;
...
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul {
    list-style-type: none;
    margin: 0;
    padding: 0;
}
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul li.fm-panel-title {
    list-style-type: none;
    margin: 0;
    padding: 0 15px;
}
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul li a.fm-panel-title:link, .style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul li a.fm-panel-title:visited {
    color: #000000;
    display: block;
    font-size: 1.4em;
    margin: 20px 0;
}
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul li.fm-panel-title li {
    background: url("http://www.twi.co.uk/EasySiteWeb/EasySite/StyleData/TWI_Master/Images/footer-nav-bullet.gif") no-repeat scroll left 0.6em transparent;
    list-style-type: none;
    margin: 0;
    padding: 0 0 0 10px;
}
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul li.fm-panel-title li a.fm-panel-item:link, .style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel ul li.fm-panel-title li a.fm-panel-item:visited {
    color: #333333;
    display: block;
    padding: 4px 0;
}
.style-element-outer.custom-menu.custom-menu-TWI-Bottom .footer-menu-panel.fn-panel-alpha {
    background: none repeat scroll 0 0 transparent;
}
.footer-links {
    color: #D3D3D3;
...
#footer-link-container a:hover, a:active {
    color: #444444;
    text-decoration: underline;
}
.technologies-footer-links {
    float: left;
    margin: 0;
    padding: 0;
    width: 210px;
}
.technologies-footer-links h2 {
    color: #000000;
...
.technologies-footer-links ul {
    margin-left: 0;
    padding-left: 0;
}
.industries-footer-links {
    float: left;
    margin: 0;
    padding: 0;
    width: 210px;
}
.industries-footer-links h2 {
    color: #000000;
    font-size: 1.4em !important;
    font-weight: normal;
    margin: 0 0 10px;
...
.services-footer-links ul {
    margin-left: 0;
    padding-left: 0;
}
.companies-footer-links {
    float: left;
    margin: 0;
    padding: 0;
    width: 330px;
}
.companies-footer-links h2 {
    color: #000000;
    font-size: 1.4em !important;
    font-weight: normal;
    margin: 0 0 10px;
...
.companies-footer-links ul {
    margin-left: 0;
    padding-left: 0;
}
.companies-footer-links-bx-one {
    float: left;
    margin: 0;
    padding: 0;
    width: 165px;
}
.companies-footer-links-bx-one ul {
    margin-left: 0;
    padding-left: 0;
}
.companies-footer-links-bx-two {
    float: right;
    margin: 0;
    padding: 0;
    width: 165px;
}
.companies-footer-links-bx-two ul {
    margin-left: 0;
    padding-left: 0;
}
